...
class HeartDataset:
    '''
    This class is for the heart segmentation dataset from the decathlon dataset.
    ...
    heart_dataset.download('all')  # Download and extract subgroup 100
    ```
    '''
    def __init__(self, dataset_size=20):
        self.dataset_size = dataset_size
        self.dataset_subgroups = {
            'all': 'https://drive.google.com/uc?id=1rOI5OMydkXaScpAXK5R-oulKgzD8JkLr'
        }
        self.base_path = 'datasets/'

    def info(self):
        print(f"Heart Dataset from Decathlon dataset. This is a collection of CT scans with means these are 3D volumes.")
