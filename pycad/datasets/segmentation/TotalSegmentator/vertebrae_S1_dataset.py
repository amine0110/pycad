...
class VertebraeS1Dataset:
    '''
    This class is for the vertebrae s1 segmentation dataset from the total segmentator dataset.
    You can get more information about it using `info()` function.

    ### Example usage

    ```Python
    from pycad.dataset.segmentation.TotalSegmentator import VertebraeS1Dataset
    
    vertebrae_s1_dataset = VertebraeS1Dataset()
    vertebrae_s1_dataset.info()  # Print dataset information
    vertebrae_s1_dataset.download('100')  # Download and extract subgroup 100
    ```
    '''
    def __init__(self, dataset_size=1225):
        self.dataset_size = dataset_size
        self.dataset_subgroups = {
            '100': 'https://drive.google.com/uc?id=134sXXCylPk9Vx6JR6YXbyAxsuYjS7jXN',
            '200': 'https://drive.google.com/uc?id=1ree2MU2XM7r0WY92XtW7SSWLUXqPqWPW',
            '400': 'https://drive.google.com/uc?id=1g9ai3IbKNun8cfE9jfWCoWmeQhL3x_Wf',
            'all': 'https://drive.google.com/uc?id=1n3rNSy4rkiM-6_9LRLojYDKSsylL8W3_'
        }
        self.base_path = 'datasets/'

    def info(self):
        print(f"Vertebrae S1 Dataset from Total Segmentator dataset. This is a collection of CT scans with means these are 3D volumes.")
    ...
    def _download_and_extract(self, url, path, subgroup):
        ...
        try:
            file_path = os.path.join(path, f'vertebrae_s1{subgroup}.zip')
