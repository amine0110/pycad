...
class KidneyRightDataset:
    '''
    This class is for the kidney right segmentation dataset from the total segmentator dataset.
    ...
    kidney_right_dataset.download('100')  # Download and extract subgroup 100
    ```
    '''
    def __init__(self, dataset_size=1225):
        self.dataset_size = dataset_size
        self.dataset_subgroups = {
            '100': 'https://drive.google.com/uc?id=1mmfyR8sX2pZS-2OsL3R92ZuGpuuEfc2P',
            '200': 'https://drive.google.com/uc?id=1AZ2erz0Q32E_nFSsKSeQjyzu6wE3VPci',
            '400': 'https://drive.google.com/uc?id=1wFeRLyZtVjeZxrI4-Ll02FGGr8YgyVY3',
            'all': 'https://drive.google.com/uc?id=1q1Pr4ORVb2N96-T-DZgO3wXbVN-1uJYY'
        }
        self.base_path = 'datasets/'

    def info(self):
        print(f"Kidney Right Dataset from Total Segmentator dataset. This is a collection of CT scans with means these are 3D volumes.")
    ...
    def _download_and_extract(self, url, path, subgroup):
        ...
        try:
            file_path = os.path.join(path, f'kidney_right{subgroup}.zip')
