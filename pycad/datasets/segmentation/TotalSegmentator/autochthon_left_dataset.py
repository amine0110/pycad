...
class AutochthonLeftDataset:
    '''
    This class is for the autochthon left segmentation dataset from the total segmentator dataset.
    ...
    def __init__(self, dataset_size=1225):
        ...
        self.dataset_subgroups = {
            '100': 'https://drive.google.com/uc?id=1QXoVOHVyJr9L-k5OoP6NFZLaoKTKzPL3',
            '200': 'https://drive.google.com/uc?id=1NulTTWfD4nvA8Cdar4dpdG7330-6D06I',
            '400': 'https://drive.google.com/uc?id=1LT7A8rfjRPSq4BpycTmFME_e0TCmnDzv',
            'all': 'https://drive.google.com/uc?id=1oRJA1T1a4Bsp6iHnmSDUdrqDLD9VWHBz'
        }
        self.base_path = 'datasets/'

    def info(self):
        print(f"Autochthon Left Dataset from Total Segmentator dataset. This is a collection of CT scans with means these are 3D volumes.")
    ...
    def _download_and_extract(self, url, path, subgroup):
        ...
        try:
            file_path = os.path.join(path, f'autochthon_left{subgroup}.zip')
