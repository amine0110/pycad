...
class RibRight6Dataset:
    '''
    This class is for the rib right 6 segmentation dataset from the total segmentator dataset.
    You can get more information about it using `info()` function.

    ### Example usage

    ```Python
    from pycad.dataset.segmentation.TotalSegmentator import RibRight6Dataset
    
    rib_right_6_dataset = RibRight6Dataset()
    rib_right_6_dataset.info()  # Print dataset information
    rib_right_6_dataset.download('100')  # Download and extract subgroup 100
    ```
    '''
    def __init__(self, dataset_size=1225):
        self.dataset_size = dataset_size
        self.dataset_subgroups = {
            '100': 'https://drive.google.com/uc?id=1U3y8qa9cxypcHZc7V-IZF2BvKiWUP8Ar',
            '200': 'https://drive.google.com/uc?id=1kf3e_pbPkekTKBnk5a801oI4mTHpOu7k',
            '400': 'https://drive.google.com/uc?id=1n1QLUZMv30TfNJZFgkOIoqCc_Ji2eyMm',
            'all': 'https://drive.google.com/uc?id=1sYm75tvyu_G1Q5tQwD5sXABZzwcuhKP9'
        }
        self.base_path = 'datasets/'

    def info(self):
        print(f"Rib Right 6 Dataset from Total Segmentator dataset. This is a collection of CT scans with means these are 3D volumes.")
    ...
    def _download_and_extract(self, url, path, subgroup):
        ...
        try:
            file_path = os.path.join(path, f'rib_right_6{subgroup}.zip')
