...
class AdrenalGlandLeftDataset:
    '''
    This class is for the adrenal gland left segmentation dataset from the total segmentator dataset.
    ...
    def __init__(self, dataset_size=1225):
        ...
        self.dataset_subgroups = {
            '100': 'https://drive.google.com/uc?id=1sySS42EtlTddczKy3PQz5oXY4jgpklgy',
            '200': 'https://drive.google.com/uc?id=1iU9tzIPhoAxlRAeSrj14z90XgeQOB7FY',
            '400': 'https://drive.google.com/uc?id=1V631BqpN7k7iPkHF0Tse4J8tfeKLfcpu',
            'all': 'https://drive.google.com/uc?id=1jaXVQGZURDHz8pmwGKRrzhYscO7XEcfr'
        }
        self.base_path = 'datasets/'

    def info(self):
        print(f"Adrenal Gland Left Dataset from Total Segmentator dataset. This is a collection of CT scans with means these are 3D volumes.")
    ...
    def _download_and_extract(self, url, path, subgroup):
        ...
        try:
            file_path = os.path.join(path, f'adrenal_gland_left{subgroup}.zip')
