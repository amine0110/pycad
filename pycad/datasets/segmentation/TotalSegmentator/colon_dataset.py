...
class ColonDataset:
    '''
    This class is for the colon segmentation dataset from the total segmentator dataset.
    ...
    def __init__(self, dataset_size=1225):
        ...
        self.dataset_subgroups = {
            '100': 'https://drive.google.com/uc?id=1HC7Fr6f8m4YUTxElwf16xk_cSyA3eluK',
            '200': 'https://drive.google.com/uc?id=1-gdRBb4mft1jLB-lDWQHCBAMqSWcJUfN',
            '400': 'https://drive.google.com/uc?id=1ZOCWvTY9utI7YDEyRrVzyfc5jxsW-UlO',
            'all': 'https://drive.google.com/uc?id=1tk_s0kfZlhUvZYu4poArMS-qIikSAAH9'
        }
        self.base_path = 'datasets/'

    def info(self):
        print(f"Colon Dataset from Total Segmentator dataset. This is a collection of CT scans with means these are 3D volumes.")
